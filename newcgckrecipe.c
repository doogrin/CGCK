modded class PluginRecipesManagerBase
{
    override void RegisterRecipies()
    {
        ...
        RegisterRecipe(new CraftGunCleaningKit);
    }
};
class CraftGunCleaningKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Gun Cleaning Kit";
		...
		//result1
		AddResult("WeaponCleaningKit");//add results here
